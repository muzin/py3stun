...
def stun_test(sock, host, port, source_ip, source_port, send_data=""):
    ...
    while not recvCorr:
        ...
        while not recieved:
            ...
            try:
                ...
                if count > 0:
                    ...
                    retVal['Resp'] = False
                    return retVal
        msgtype_bytes = binascii.b2a_hex(buf[0:2])
        msgtype = str(int(msgtype_bytes)).rjust(4, '0')
        ...
        if bind_resp_msg and tranid_match:
            ...
            base = 20
            while len_remain:
                attr_type_bytes = binascii.b2a_hex(buf[base:(base + 2)])
                attr_type = str(int(attr_type_bytes)).rjust(4, "0")
