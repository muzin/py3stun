...
class TestCLI(unittest.TestCase):
    ...
    def test_cli_parser_default(self):
        ...
        self.assertEqual(options.source_ip, py3stun.DEFAULTS['source_ip'])
        self.assertEqual(options.source_port, py3stun.DEFAULTS['source_port'])
        self.assertEqual(options.stun_port, py3stun.DEFAULTS['stun_port'])
